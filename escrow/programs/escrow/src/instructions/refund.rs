...
use anchor_spl::{
    associated_token::AssociatedToken, token_2022::transfer_checked, token_interface::{ Mint, TokenAccount, TokenInterface, TransferChecked, CloseAccount, close_account}
};
...
pub struct Refund<'info> {
    ...
    #[account(
        mut,
        close = maker,
        has_one = mint_a,  //check to see if maker has mint_a
        has_one = maker,
